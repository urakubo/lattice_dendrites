...
* Python3.6.X / CUDA11.0 / Linux (e.g., Ubuntu18.04) or Python3.8.X / CUDA11.4 / Linux (e.g., Ubuntu20.04)
* pip
* Virtual environment such as venv, virtualenv, and conda, if preferred
* ffmpeg
