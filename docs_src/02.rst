...
Then execute 'lm -l' to confirm successful settings. You will see the following message:
...
.. code-block:: bash
	...
	>>> import pyLD
	Imported pyLD files:
	create_surface, save_uniem_annotator, BuildAnyShapeOrg, CreateVolumeFromReconstruct, GenerateClosedVolumesFromUniEM, BuildAnyShape, RotateVolume, utils, get_labeled_concs
	>>>
