...
project = 'lattice dendrites'
copyright = '2022, Hidetoshi Urakubo'
...
# ones.
extensions = ['sphinx.ext.autosummary','sphinx.ext.githubpages',"sphinx.ext.autodoc", 'sphinx.ext.napoleon', 'sphinxcontrib.video', 'sphinxcontrib.googleanalytics']

googleanalytics_id = 'G-C62LL715FS'
