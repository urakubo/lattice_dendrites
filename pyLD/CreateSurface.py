...
class CreateSurface:
	...
	def __init__(pitch, volume, PSD = None, num_smoothing = 30, method_smoothing = 'humphrey'):
		...
		# Surface area
		surf_voxel_locs, surf_voxel_area = assign_surface_to_surface_volume(volume, v=v_smooth, f=f_smooth)

		# PSD area
		if PSD is not None:
			PSD_voxel_locs, PSD_voxel_area = assign_surface_to_surface_volume(volume, v=v_smooth, f=f_smooth[id_face_psd,:])
	...
	def get_surface_to_surface_volume(self)
		#
		v = self.v
		f = self.f
